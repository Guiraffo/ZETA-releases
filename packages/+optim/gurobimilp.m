function [x,fval,exitflag,output] = gurobimilp(f,Aineq,bineq,Aeq,beq,ctype,Display)
%GUROBIMILP calls Gurobi to solve a mixed integer linear program
%
%   SYNTAX: [x,fval,exitflag,output] = GUROBIMILP(f,Aineq,bineq,Aeq,beq,ctype,Display)
...
elseif(strcmp(Display,'off'))
    ...
    error('Invalid Display parameter in gurobimilp');
end
