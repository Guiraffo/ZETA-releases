...
%CONVEXHULL computes the convex hull of several constrained zonotopes
%           using the method in Raghuraman and Koeln (2022), iteratively
%
%   SYNTAX: Znew = CONVEXHULL(Z1,Z2,...)
%
%   INPUTS
%             Zi: the i-th constrained zonotope
%
%   OUTPUT
...
Znew_.b = Z{1}.b;
for i=2:nof_sets
    Znew_ = convexhull_Raghuraman(Znew_,Z{i});
end
